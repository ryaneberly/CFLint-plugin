...
import org.jenkinsci.plugins.cfbugs.parser.LintAnnotation;
import org.jenkinsci.plugins.cfbugs.parser.LintParser;
import org.jenkinsci.plugins.cfbugs.parser.Location;
...
public class LintParserTest extends TestCase {
    ...
    private static void assertUnknownIssue(LintAnnotation a) {
        assertEquals(Messages.CFBugs_Parser_UnknownCategory(), a.getCategory());
        assertEquals(Messages.CFBugs_Parser_UnknownExplanation(a.getType()),
                a.getExplanation());
    }
